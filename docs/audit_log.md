...
## Curation decisions per track

Generated by `src.video_runtime.window_oracle` after each `make track`.

| Track | Best window (snow stream indices) | OK% | Smoothing | Curated |
|---|---|---|---|---|
| `boreas_2021_01_26` | frames 100–249 (150) | 96.0% | hole≤5f | 2026-05-07 |
