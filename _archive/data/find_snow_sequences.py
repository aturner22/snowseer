...
# Bboxes (W, S, E, N) for 1km-ish winter snow city centres.
CITIES = {
    "tromso":     (18.93, 69.64, 19.00, 69.68),   # NO — coloured timber houses, fjord
    "reykjavik":  (-21.96, 64.13, -21.91, 64.16), # IS — pastel buildings, dramatic skies
    "bergen":     ( 5.31, 60.39,  5.34, 60.41),   # NO — Bryggen Hanseatic warehouses
    "quebec":     (-71.21, 46.80, -71.20, 46.82), # CA — Petit-Champlain, Old Town
    "innsbruck":  (11.38, 47.26, 11.41, 47.28),   # AT — baroque facades, alpine
    "sapporo":    (141.34, 43.05, 141.36, 43.07), # JP — Odori, neon
    "kiruna":     (20.21, 67.85, 20.24, 67.87),   # SE — already known to us
}
